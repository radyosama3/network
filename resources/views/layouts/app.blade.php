                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">السجل المدني</a></li>
                            <li><a class="dropdown-item" href="#">طباعة شهادة ميلاد</a></li>
                            <li><a class="dropdown-item" href="#">الإقامة والجوازات</a></li>
                        </ul>
                    </li>
